//#region data/role-info/fool.js
var fool_default = [
	{ heading: "Summary" },
	"\"The 1st time you die, you don't.\"",
	"The Fool escapes death... once.",
	["The first time the Fool dies for any reason, the Fool remains alive. They don’t learn that their ability saved their life.", "If another character’s ability protects the Fool from death, the Fool does not use their ability. Only the time that the Fool would actually for realsy bona fide be dead does the Fool’s ability trigger."],
	{ heading: "How to Run" },
...
//#endregion
export { fool_default as default };
