...
* SPDX-License-Identifier: BSD-3-Clause
*/ const { is: i$2, defineProperty: e$1, getOwnPropertyDescriptor: h$1, getOwnPropertyNames: r$1, getOwnPropertySymbols: o$2, getPrototypeOf: n$1 } = Object, a$1 = globalThis, c$1 = a$1.trustedTypes, l$1 = c$1 ? c$1.emptyScript : "", p$1 = a$1.reactiveElementPolyfillSupport, d$1 = (t, s) => t, u$1 = {
	toAttribute(t, s) {
		switch (s) {
			case Boolean:
				t = t ? l$1 : null;
...
i$3`var(--ui-main-1)`;
i$3`var(--ui-main-2)`;
const main3 = i$3`var(--ui-main-3)`;
const main4 = i$3`var(--ui-main-4)`;
const main5 = i$3`var(--ui-main-5)`;
i$3`var(--ui-main-6)`;
i$3`var(--ui-main-7)`;
i$3`var(--ui-main-8)`;
i$3`var(--ui-main-9)`;
i$3`var(--ui-secondary-0)`;
i$3`var(--ui-secondary-1)`;
i$3`var(--ui-secondary-2)`;
i$3`var(--ui-secondary-3)`;
i$3`var(--ui-secondary-4)`;
i$3`var(--ui-secondary-5)`;
i$3`var(--ui-secondary-6)`;
i$3`var(--ui-secondary-7)`;
i$3`var(--ui-secondary-8)`;
i$3`var(--ui-secondary-9)`;
i$3`var(--ui-error-0)`;
i$3`var(--ui-error-1)`;
i$3`var(--ui-error-2)`;
i$3`var(--ui-error-3)`;
...
i$3`var(--ui-error-8)`;
i$3`var(--ui-error-9)`;
const neutral = i$3`var(--ui-neutral)`;
i$3`var(--ui-bg-0)`;
const bg1 = i$3`var(--ui-bg-1)`;
const bg2 = i$3`var(--ui-bg-2)`;
const bg3 = i$3`var(--ui-bg-3)`;
const bg4 = i$3`var(--ui-bg-4)`;
const bg5 = i$3`var(--ui-bg-5)`;
const bg6 = i$3`var(--ui-bg-6)`;
const bg7 = i$3`var(--ui-bg-7)`;
const bg8 = i$3`var(--ui-bg-8)`;
const bg9 = i$3`var(--ui-bg-9)`;
/** SPACING */
const spacer4 = i$3`4px`;
const spacer8 = i$3`8px`;
const spacer12 = i$3`12px`;
const spacer16 = i$3`16px`;
const spacer20 = i$3`20px`;
i$3`24px`;
i$3`32px`;
const spacer40 = i$3`40px`;
i$3`48px`;
i$3`52px`;
i$3`56px`;
i$3`64px`;
i$3`72px`;
const spacer80 = i$3`80px`;
i$3`100px`;
/** BORDER */
const borderRadius = i$3`8px`;
const border = i$3`var(--ui-border)`;
const elevation4 = () => i$3`
  box-shadow:
    0 0 4px 0 rgba(0, 0, 0, 0.12),
    0 4px 4px 0 rgba(0, 0, 0, 0.24);
`;
const elevation12 = () => i$3`
  box-shadow:
    0 0 12px 0 rgba(0, 0, 0, 0.12),
    0 12px 12px 0 rgba(0, 0, 0, 0.24);
`;
const elevation24 = () => i$3`
  box-shadow:
    0 0 24px 0 rgba(0, 0, 0, 0.32),
    0 24px 24px 0 rgba(0, 0, 0, 0.44);
`;
i$3`rgb(159 202 234)`;
const focus = ({ color = i$3`var(--ui-secondary-4)`, radius = i$3`4px` } = {}) => i$3`
  border-radius: ${radius};
  box-shadow:
    ${color} 0px 0px 12px,
    ${color} 0px 0px 0px 3px;
  outline: 2px;
...
//#endregion
//#region node_modules/@thepassle/app-tools/utils/index.js
/**
...
//#endregion
export { i as A, spacer12 as C, spacer40 as D, spacer4 as E, j as F, i$3 as I, r$2 as L, D as M, E as N, spacer8 as O, b as P, neutral as S, spacer20 as T, focus as _, bg3 as a, main4 as b, bg6 as c, bg9 as d, border as f, elevation4 as g, elevation24 as h, bg2 as i, A as j, spacer80 as k, bg7 as l, elevation12 as m, ALIGNMENT_COLORS as n, bg4 as o, borderRadius as p, bg1 as r, bg5 as s, when as t, bg8 as u, header as v, spacer16 as w, main5 as x, main3 as y };
